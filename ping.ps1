...
Write-Output ""
$Servers = "1.1.1.1", "8.8.8.8", "128.1.120.194", "google.com", "quicksight.ap-south-1.amazonaws.com", "quicksight.ap-southeast-1.amazonaws.com", "mumbaispeedtest1.airtel.in", "speedtestdel.airtelbroadband.in", "speedtestchn1.airtel.in"
